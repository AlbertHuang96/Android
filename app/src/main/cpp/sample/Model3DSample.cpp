...
void Model3DSample::Init()
{
    ...
    char fShaderStr[] =
            ...
            "    vec3 Specular = texture(texture_specular1, v_texCoord).rgb;\n"
            "    vec3 specularColor = specular * Specular;"
            "    vec3 diffuseColor = (ambient + diffuse) * vec3(objectColor);\n"
...
{
    SampleBaseGL::UpdateTransformMatrix(rotateX, rotateY, scaleX, scaleY);
